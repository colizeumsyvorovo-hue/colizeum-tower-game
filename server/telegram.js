  ...
  bot.command('start', async (ctx) => {
    ...
    try {
      ...
      const welcomeMessage = 
        ...
        `🎲 <b>Как играть:</b>\n` +
        `• Блок раскачивается на верёвке\n` +
        `• Нажми в нужный момент, чтобы установить блок\n` +
        `• Идеальное попадание (Perfect) даёт больше бонусов\n` +
        `• Чем выше башня, тем сложнее играть\n\n` +
